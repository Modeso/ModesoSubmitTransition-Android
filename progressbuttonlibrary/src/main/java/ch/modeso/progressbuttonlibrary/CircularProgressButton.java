...
public class CircularProgressButton extends AppCompatButton implements OnAnimationUpdateListener {
    ...
    public void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            mColorProgress = attr.getColor(R.styleable.CircularProgressButton_pb_colorProgress, getColor(R.color.colorAccent));
            mColorIndicator = attr.getColor(R.styleable.CircularProgressButton_pb_colorIndicator, blue);
            mColorProgressCancelIcon = Color.TRANSPARENT;
            mColorIndicatorBackground =
                    attr.getColor(R.styleable.CircularProgressButton_pb_colorIndicatorBackground, getColor(R.color.colorAccent));
    ...
    private void drawProgress(Canvas canvas) {
        if (mAnimatedDrawable == null) {
            ...
            int indicatorPadding = 30;
            int left = offset + indicatorPadding;
            int right = getWidth() - offset - indicatorPadding;
            int bottom = getHeight() - indicatorPadding;
            int top = indicatorPadding;
